import {deepen} from "/lib/utils/object_utils";
...
export const validateForm = function(formObject, validationCallback, errorCallback, submitCallback, options) {
	...
	formObject.find("input,select,textarea").each(function() {
		...
		var dataType = options.fields[fieldName].type || inputObject.attr("data-type") || "STRING";
		dataType = dataType.toUpperCase();

		var dataFormat = options.fields[fieldName].format || inputObject.attr("data-format") || "";
		var minValue = options.fields[fieldName].min || inputObject.attr("data-min") || "";
		var maxValue = options.fields[fieldName].max || inputObject.attr("data-max") || "";
		var isRequired = options.fields[fieldName].required || !!inputObject.attr("required");
